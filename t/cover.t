...

{
    ...
    is( $obj->set_isSender(1), CKR_OK, '$obj->set_isSender(1)' );
    is( $obj->set_isSender(0), CKR_OK, '$obj->set_isSender(0)' );
    is( $obj->set_isSender(0), CKR_OK, '$obj->set_isSender(0)' );
    ...
    is( $obj->set_bIsExport(1), CKR_OK, '$obj->set_bIsExport(1)' );
    is( $obj->set_bIsExport(0), CKR_OK, '$obj->set_bIsExport(0)' );
    is( $obj->set_bIsExport(0), CKR_OK, '$obj->set_bIsExport(0)' );
    is( $obj->set_RandomInfo($randomInfo), CKR_OK, '$obj->set_RandomInfo($randomInfo)' );
    is( $obj->set_RandomInfo($randomInfo), CKR_OK, '$obj->set_RandomInfo($randomInfo)' );
    ok( $bytes = $obj->toBytes, '$obj->toBytes' );
    ...
    my @a = ($obj, $obj2);
    isa_ok( $obj = Crypt::PKCS11::CK_OTP_PARAMS->new, 'Crypt::PKCS11::CK_OTP_PARAMSPtr', 'Crypt::PKCS11::CK_OTP_PARAMS->new' );
    is( $obj->set_pParams(\@a), CKR_OK, '$obj->set_pParams(\@a)' );
    is( $obj->set_pParams(\@a), CKR_OK, '$obj->set_pParams(\@a)' );
# TODO:
# Attempt to free unreferenced scalar: SV 0x2e19fd8, Perl interpreter: 0x2195010 during global destruction.
#    is( $obj->get_pParams($b = []), CKR_OK, '$obj->get_pParams($b = [])' );
